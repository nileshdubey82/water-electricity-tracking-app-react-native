...
const WaterBillList = ({ navigation }) => {
    const [bills, setBills] = useState([
        { month: 'April', amount: 80, isPaid: false },
        { month: 'May', amount: 100, isPaid: true },
        { month: 'June', amount: 70, isPaid: false },
    ...
    const handlePrintBill = () => {
        if (selectedBill) {
            navigation.navigate('WaterUsageBill', {
    ...
    return (
        <View style={styles.container}>
         <Text style={{ color: 'black', fontSize: 25, borderBottomColor: 'black', borderBottomWidth: 1, marginBottom: 10 ,fontWeight:'bold'}}>Water Bill Payments</Text>
            <FlatList
                data={bills}
